...
def main() -> None :
    ...
    outputFilePath = r"C:\AI&ML\my-AI-ML-journey\Python-AIML\003_Statistics\001_StatisticalMean\002_WeightedMean\DataSets\EnhancedData\RetailSalesRecordsEnhancedData.xlsx"
